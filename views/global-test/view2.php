...
/*        'rowOptions' => function ($model, $key, $index, $grid) {
                        ...
                        return ['test_name' => $model['TESTNAME'], 'onmouseover' => '', 'style' => 'cursor: pointer;', 'onclick' => 'window.open("/test-results/view3?test_name='.$model["TESTNAME"].'", "popup", "height=770,width=1200, menubar=no, resizable=yes,scrollbars=yes,status=1, top=10, left=10");'];
